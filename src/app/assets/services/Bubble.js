	...
	function(User, $rootScope, Auth, $analytics, $state, $compile, $document, $timeout, ViewportUtils) {
		...
		var bubbleDefinitions = {
			'hide-post': {
				...
				apply: function() {
					var template = 'assets/components/bubble/bubble/hide-post-option.html';
			...
			'bookmark-reminder': {
				...
				apply: function() {
					var template = 'assets/components/bubble/bubble/bookmark-reminder.html';
					var placeholder = bubblePlaceholderSearch({
			...
			'marketplace-item-mood': {
				...
				apply: function() {
					var template = 'assets/components/bubble/bubble/marketplace-item-mood.html';
