...
angular.module('hearth.services').factory('Cookie', ['$document', function($document) {
	return {
		get: function(cname) {
			var name = cname + '=';
