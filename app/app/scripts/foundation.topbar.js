/* This file contains bug fix see #220
* If you want to upgrade foundation test first behaior (they could fixed it), and then you can remove this
*/
      ...
      S(this.scope)
        ...
        .on('click.fndtn.topbar', '[' + this.attr_name() + '] .has-dropdown>a', function (e) {
          if (self.breakpoint()) {
            ...
            if (!self.small()) {//this fixes wrong behavior when click dropdow link without url
