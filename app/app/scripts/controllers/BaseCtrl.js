...
angular.module('hearth.controllers').controller('BaseCtrl', [
    '$scope', '$locale', '$rootScope', '$location', '$route', 'Auth', 'ApiHealthChecker', 'ngDialog', '$timeout', '$interval', '$element', 'CommunityMemberships', '$window', 'Post', 'Tutorial', 'Notify',

    function($scope, $locale, $rootScope, $location, $route, Auth, ApiHealthChecker, ngDialog, $timeout, $interval, $element, CommunityMemberships, $window, Post, Tutorial, Notify) {
        var timeout;
