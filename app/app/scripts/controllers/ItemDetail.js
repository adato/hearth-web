...
angular.module('hearth.controllers').controller('ItemDetail', [
	'$scope', 'ItemDetailResource', '$routeParams', 'ResponseErrors', '$rootScope', 'OpenGraph', 'Post',

	function($scope, ItemDetailResource, $routeParams, ResponseErrors, $rootScope, OpenGraph, Post) {
		$scope.ad = {};
		$scope.show = false;
		...
		$scope.removeAd = function($event, id) {
			Post.remove({
				postId: id
			});
