  ...
  function ($translate, $rootScope, Filter, Karma, $timeout, $filter) {
    return {
      ...
      link: function (scope, element) {
        ...
        // default values
        scope.toggleTag = (scope.inactivateTags) ? function () {
        } : Filter.toggleTag;
        ...
        scope.$watch('item', function (item) {
          ...
          scope.isExpiringSoon = !scope.item.valid_until == 'unlimited' && moment(scope.item.valid_until).subtract(7, 'days').isBefore(new Date())
